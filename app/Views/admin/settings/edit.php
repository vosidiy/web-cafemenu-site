...
<header class="md:d-flex align-items-center justify-content-between py-4">
    <h2 class="text-3xl"> Настройки </h2>
</header>

<div class="card">
    <div class="card-body">
        <p class="mb-3"> <b>Login: </b> <?= esc($cafe['username']) ?>   • <b>Pairing code:</b> <?= esc($cafe['code'] ?? '-') ?> (For tablet or smartphone app) 
        
        </p>
        <hr>
        <h5 class="text-xl mb-3">🏚️ О ресторане</h5>
        <form method="post" action="<?= site_url('admin/settings') ?>" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="row">
                <div class="md:col-6 mb-4">
                    <label class="form-label">Имя владельца или менеджера</label>
            ...
            <hr>
            <h5 class="text-xl mb-3">🌐 Языки меню</h5>
            <?php
                $selectedLanguages = [];
            ...
            <hr>
            <h5 class="text-xl mb-3">🎨 Другие настройки</h5>
            ...
            <hr>
            <h5 class="text-xl mb-3">💵 Дополнительная плата </h5>
            ...
            <div class="form-check my-4">
                ...
                >
                <label class="form-check-label" for="extraFeeEnabled">Включить (за обслуживание, доставка...)</label>
            </div>
            <div class="row">
                ...
                <div class="md:col-4 mb-5">
                    <label class="form-label">Сумма  или процент (без знака `%`)</label>
                    <input
                        type="number"
                        step="0.01"
                        min="0.01"
            ...
            <?php foreach ($cafeLanguages as $language): ?>
                ...
                <div class="md:col-4 mb-4">
                    <label class="form-label">
                        Название доп. платы: <?= esc(($language['flag'] ?? '') . ' ' . $language['native_label']) ?>
...
<div class="card my-5">
    <div class="card-body">
        <h5 class="text-xl mb-3">🔒 Изменить пароль</h5>
